...
| **v2.0** | Hiện tại | - **Loại bỏ hoàn toàn Module Chat** khỏi tài liệu SRS. <br>- Cấp quyền **Write** cho Trưởng bộ môn (`HeadOfDept`) với Lớp học, Phân công giảng dạy và Thời khóa biểu. | Nâng cao quyền quản lý cho cấp tổ chuyên môn. |
