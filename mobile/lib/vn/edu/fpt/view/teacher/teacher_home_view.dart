...
import 'teacher_class_summary_view.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              _buildActionTile(
                ...
                subtitle: 'Điểm danh, danh sách lớp',
              ...
              _buildActionTile(
                ...
                label: 'Tổng kết lớp',
                subtitle: 'Xem học bạ lớp chủ nhiệm (chỉ đọc)',
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const TeacherClassSummaryView()),
                ),
              ),
            ],
          ),
