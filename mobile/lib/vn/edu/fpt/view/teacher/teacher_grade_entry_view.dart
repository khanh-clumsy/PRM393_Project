    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.errorMessage.value.isNotEmpty &&
            controller.academicYears.isEmpty) {
          return Center(
            child: Column(
        ...
        int enteredStudents = controller.students
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<int>(
                                    ...
                                    items: controller.filteredSemesters.map((
                                      s,
                                    ) {
                                      return DropdownMenuItem<int>(
                                        value: s.semesterId,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    'Đã nhập: $enteredStudents/$totalStudents',
                    style: TextStyle(
                      fontSize: 12,
                ...
                builder: (context) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final initialText = student.score != null
                          ? (student.score! % 1 == 0
                                ? student.score!.toInt().toString()
                      ...
                      final initials = nameParts.length > 1
                          ? '${nameParts[0][0]}${nameParts.last[0]}'
                                .toUpperCase()
