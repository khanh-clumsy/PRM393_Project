...
public record AnnouncementDto(int AnnouncementId, int AuthorId, string Title, string Content, string AnnouncementType, string Priority, DateTime CreatedAt, List<int?> TargetClassIds);
